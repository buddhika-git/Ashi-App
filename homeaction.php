...
if (isset($_POST["categoryhome"])) {
    // Fetch all categories except the one with cat_id = 1
    ...
    $fish_count_array = mysqli_fetch_array($query);
    $fish_count = $fish_count_array['count_items'];
    ...
    echo "
        ...
        <div id='responsive-nav'>
            ...
            <ul class='main-nav nav navbar-nav'>
                ...
                <li><a href='store.php'>Fish ($fish_count)</a></li>
        ";
    ...
    if (mysqli_num_rows($run_query) > 0) {
        while ($row = mysqli_fetch_array($run_query)) {
            ...
            // Get the count of items in the current category
            ...
            echo "
                <li class='categoryhome' cid='$cid'><a href='store.php?cid=$cid'>$cat_name ($count)</a></li>
            ";
        }
